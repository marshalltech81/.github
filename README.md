...
This repository holds the shared community files and templates for repositories owned by this account.

It is the common starting point for how my projects handle:
...
This repository is not where the project code lives.

It exists to provide the shared community and contribution defaults behind my personal projects and open source work.